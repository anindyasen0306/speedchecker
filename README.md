...
lab_down = Label(sp, text="00", font=("Time New Roman", 20, "bold"), bg="black", fg="red")
lab_down.place(x=60, y=180, height=50, width=380)
lab = Label(sp, text="Upload Speed", font=("Time New Roman", 20, "bold"), )
lab.place(x=60, y=290, height=50, width=380)
lab_up = Label(sp, text="00", font=("Time New Roman", 20, "bold"), bg="black", fg="pink")
lab_up.place(x=60, y=340, height=50, width=380)
button = Button(sp, text="Check Speed", font=("Time New Roman", 20, "bold"), relief=RAISED, bg="green",
                command=speedcheck)
